...
insert into orders (id, total, paid_amount, paid_cash, paid_visa, paid_wallet, paid_instapay, payment_method, type, customer_id, cashier_name, created_at) values
  ...
  ('2', 2850, 2850, 0, 2850, 0, 0, 'visa', 'sale', 'd1000000-0000-0000-0000-000000000002', 'كاشير ديمو', now() - interval '2 days'),
  ('3', 4400, 4400, 0, 0, 0, 4400, 'instapay', 'sale', 'd1000000-0000-0000-0000-000000000003', 'كاشير ديمو', now() - interval '2 days'),
  ('4', 1950, 1950, 1950, 0, 0, 0, 'cash', 'sale', 'd1000000-0000-0000-0000-000000000004', 'كاشير ديمو', now() - interval '1 day'),
  ('5', 3600, 3600, 0, 0, 3600, 0, 'wallet', 'sale', 'd1000000-0000-0000-0000-000000000001', 'كاشير ديمو', now() - interval '1 day'),
  ('6', 5200, 5200, 5200, 0, 0, 0, 'cash', 'sale', 'd1000000-0000-0000-0000-000000000002', 'كاشير ديمو', now() - interval '5 hours'),
  ('7', 850,  850,  850,  0, 0, 0, 'cash', 'sale', 'd1000000-0000-0000-0000-000000000003', 'كاشير ديمو', now() - interval '3 hours'),
  ('8', 6100, 6100, 0, 0, 0, 6100, 'instapay', 'sale', 'd1000000-0000-0000-0000-000000000004', 'كاشير ديمو', now() - interval '1 hour');
