...
-- 1. تصنيفات بوتيك الملابس (تطابق الشاشة الرئيسية)
...
-- 2. قائمة الموديلات والمنتجات (مأخوذة من نظام أدريا الأصلي وشاشة adria-one.vercel.app)
insert into products (id, name, barcode, purchase_price, average_purchase_price, sale_price, wholesale_price, half_wholesale_price, stock_quantity, display_quantity, category_id) values
  ('f1000000-0000-0000-0000-000000000001', 'afra pants', '2001', 400, 400, 650, 550, 600, 4, 4, 'ca000000-0000-0000-0000-000000000010'),
  ('f1000000-0000-0000-0000-000000000002', 'adidas set', '2002', 800, 800, 1290, 1100, 1200, 0, 0, 'c7000000-0000-0000-0000-000000000007'),
  ('f1000000-0000-0000-0000-000000000003', '2 بلوزة تومي', '2003', 380, 380, 600, 500, 550, 1, 1, 'c1000000-0000-0000-0000-000000000001'),
  ('f1000000-0000-0000-0000-000000000004', '-بلوزة كم مروحه', '2004', 420, 420, 690, 580, 630, 2, 2, 'c4000000-0000-0000-0000-000000000004'),
  ('f1000000-0000-0000-0000-000000000005', 'aura 1173', '2005', 450, 450, 690, 580, 630, 2, 2, 'c8000000-0000-0000-0000-000000000008'),
  ('f1000000-0000-0000-0000-000000000006', 'aura 1159', '2006', 600, 600, 950, 800, 870, 1, 1, 'c5000000-0000-0000-0000-000000000005'),
  ('f1000000-0000-0000-0000-000000000007', 'aura 021', '2007', 180, 180, 300, 240, 270, 18, 18, 'c9000000-0000-0000-0000-000000000009'),
  ('f1000000-0000-0000-0000-000000000008', 'afra top lenin', '2008', 150, 150, 250, 200, 220, 12, 12, 'c4000000-0000-0000-0000-000000000004'),
  ('f1000000-0000-0000-0000-000000000009', 'AURA CHEMISE 1003', '2009', 500, 500, 750, 640, 690, 1, 1, 'c6000000-0000-0000-0000-000000000006'),
  ('f1000000-0000-0000-0000-000000000010', 'aura 309', '2010', 380, 380, 590, 490, 540, 4, 4, 'c7000000-0000-0000-0000-000000000007'),
  ('f1000000-0000-0000-0000-000000000011', 'aura 2258', '2011', 280, 280, 450, 370, 410, 4, 4, 'c1000000-0000-0000-0000-000000000001'),
  ('f1000000-0000-0000-0000-000000000012', 'aura 1177', '2012', 450, 450, 690, 580, 630, 1, 1, 'c5000000-0000-0000-0000-000000000005'),
  ('f1000000-0000-0000-0000-000000000013', 'aura open hoodie 2', '2013', 400, 400, 620, 520, 570, 3, 3, 'c5000000-0000-0000-0000-000000000005'),
  ('f1000000-0000-0000-0000-000000000014', 'aura hodie micky', '2014', 420, 420, 650, 540, 590, 4, 4, 'c5000000-0000-0000-0000-000000000005'),
  ('f1000000-0000-0000-0000-000000000015', 'aura collection', '2015', 550, 550, 850, 720, 780, 3, 3, 'c7000000-0000-0000-0000-000000000007'),
  ('f1000000-0000-0000-0000-000000000016', 'AURA CHEMISE CAROH24', '2016', 480, 480, 720, 600, 660, 2, 2, 'c6000000-0000-0000-0000-000000000006'),
  ('f1000000-0000-0000-0000-000000000017', 'جاكيت جينز زارا', '2017', 500, 500, 790, 650, 720, 8, 8, 'ca000000-0000-0000-0000-000000000010'),
  ('f1000000-0000-0000-0000-000000000018', 'بناطيل ميلتون أورورا', '2018', 250, 250, 390, 320, 350, 15, 15, 'cb000000-0000-0000-0000-000000000011');

-- 3. العملاء والموردين
insert into customers (id, custom_id, name, phone, card_number, address) values
  ('d1000000-0000-0000-0000-000000000001', 'CUST-101', 'أحمد محمود (عميل ديمو)', '01012345678', '1001', 'المعادي - القاهرة'),
...
insert into orders (id, total, paid_amount, paid_cash, paid_visa, paid_wallet, paid_instapay, payment_method, type, customer_id, cashier_name, created_at) values
  ('1', 1300, 1300, 1300, 0, 0, 0, 'cash', 'sale', 'd1000000-0000-0000-0000-000000000001', 'كاشير ديمو', now() - interval '2 days'),
  ('2', 1290, 1290, 0, 1290, 0, 0, 'visa', 'sale', 'd1000000-0000-0000-0000-000000000002', 'كاشير ديمو', now() - interval '1 day'),
  ('3', 1500, 1500, 1500, 0, 0, 0, 'cash', 'sale', 'd1000000-0000-0000-0000-000000000001', 'كاشير ديمو', now() - interval '4 hours');

insert into invoice_counter (id, current_value) values (1, 4) on conflict (id) do update set current_value = 4;
