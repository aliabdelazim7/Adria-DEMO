-- =============================================================================
-- ADRIA — تصفير البيانات وإضافة منتجات وديمو شامل لبوتيك الملابس
-- شغّله في Supabase → SQL Editor لتصفير البيانات وإعادة تعيين منتجات وحسابات التجربة (Demo)
-- =============================================================================

-- 1. تصفير جميع الجداول
...
-- 4. إدخال 30+ منتج وموديل ملابس (مع أسعار الشراء، البيع، الجملة، وكميات المعرض والمخزن)
